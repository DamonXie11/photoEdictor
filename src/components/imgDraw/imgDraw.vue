  ...
  <div class="imgDraw">
    ...
    >
      ...
      <div slot="title" class="title">
        <br>
        <el-button @click="prePic" style="color: #3a8ee6; z-index: 1000">《上一张
        </el-button>

        <div class="tittle" style="display: inline-block">
          <label>&nbsp;&nbsp;&nbsp;请选择图片：</label>
          <input type="file" id="file_input" multiple @click="readFile()"/>
        </div>

        <el-button @click="nextPic" style="color: #3a8ee6; z-index: 1000">下一张》
        </el-button>
  ...
  methods: {
    prePic(){
      ...
      if(this.imgIndex >= 0)
      {
        ...
        this.picBase64 = this.imgFile[this.imgIndex];
        this.imgTittle = this.imgTittleList[this.imgIndex];
        this.currentImg.url = this.picBase64;
        this.canvasStore =this.picBase64;
        this.baseMap =this.picBase64;
      ...
      input.onchange = function () {
        ...
        for (let i = 0; i < file.length; i++) {
          if (window.FileReader) {                                                        //如果浏览器支持FileReader
            ...
            let imgBase64 = '';
            reader.readAsDataURL(file[i]);                                            //读取文件url
